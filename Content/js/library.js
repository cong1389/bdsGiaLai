...
$(document).ready(function () {
    ...
    $('.highslide').jqzoom(options);

    $("span[id^='gia']").each(function () {
        var e = $(this);
        var t = new Date;
        var n = e.attr("class");
        ...
        t.setHours(o + 1);
        t.setMinutes(u);
        t.setSeconds(a); e.find(".countdown-styled").countdown({ until: t, format: "dHMS" })
    });
...
(function (d, s, id) {
    ...
    js.src = "//connect.facebook.net/vi_VN/all.js#xfbml=1&appId=431117480318488";
...
function swap(path) {
    $('.pd-left .image img').attr("src", path);
    $('.pd-left .image #popupImg').attr("href", path);
}
$(document).ready(function () {
