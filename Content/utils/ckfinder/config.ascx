...
<script runat="server">
    ...
    {
        if (WebLogin.IsLogin()) return true;
        else return false;
    }
	...
	public override void SetConfig()
	{
        ...
        RoleSessionVar = "CKFinder_WebUser";
        ...
        type = ResourceType.Add(WebLogin.CurrentUser.Username);
        type.Url = BaseUrl + WebLogin.CurrentUser.Username.ToLower() + "/";
        type.Dir = BaseDir == "" ? "" : BaseDir + WebLogin.CurrentUser.Username.ToLower() + "/";
		type.MaxSize = 0;
