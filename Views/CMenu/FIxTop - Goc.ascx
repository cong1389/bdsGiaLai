...
<div class="nam-topbar">
    ...
    <div class="nam-dangtin">
         ...
         <%if (!WebLogin.IsLogin()){%>
        <a href="<%=ViewPage.GetURL(ViewPage.CurrentPage.MenuID,"dang-nhap") %>">Đăng nhập</a> | <a href="<%=ViewPage.GetURL(ViewPage.CurrentPage.MenuID,"dang-ky")%>">Đăng ký</a> | <a href="<%=ViewPage.GetURL(ViewPage.CurrentPage.MenuID,"dang-tin")%>">Đăng tin<img alt="Đăng tin rao cặt mua bán nhà đất - Muabanbds.net" src="/Data/upload/images/muten.png" style="width: 16px; height: 16px;" /></a>

         <%}
           else
           {%>
                <a href="<%=ViewPage.GetURL(ViewPage.CurrentPage.MenuID,"tai-khoan") %>"> Chào: <%=WebLogin.CurrentUser.Username %><img alt="Thông tin tài khoản - Muabanbds.net" src="/Content/skins/images/dang-nhap.jpg" style="width: 16px; height: 16px;" /></a> | <a href="<%=ViewPage.GetURL(ViewPage.CurrentPage.MenuID,"dang-tin-rao-vat-mua-ban-nha-dat")%>">Đăng tin<img alt="Đăng tin rao cặt mua bán nhà đất - Muabanbds.net" src="/Data/upload/images/muten.png" style="width: 16px; height: 16px;" /></a>
          <% } %>
