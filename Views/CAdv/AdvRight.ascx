...
<div class="qcrigth" id="bannerRigth">
...
<style type="text/css">
    #bannerRigth { padding: 0; width: 140px;}
    .qcrigth {
	    width: 140px;
	    height: 600px;
    }
...
<script type="text/javascript">
    ...
    var slider = Sliderman.slider({ container: 'bannerRigth', width: 140, height: 600, effects: effectsSlide, display: { autoplay: 5000 } });
</script>
