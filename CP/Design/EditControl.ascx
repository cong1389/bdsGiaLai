                    ...
                    <%if (fieldName.IndexOf("Text") > -1)
                      {
                          ...
                          %>
                       <input  type="image" class="vsw-icon" onclick="ShowTextForm('<%= currentID%>','');return false;" src="/{CPPath}/Content/add/img/search-16.gif" />
                    <%} %>
...
<tr id="tr_<%= ViewControlID%>_ViewLayout">
    <td class="key" style="font-size: 12px; font-weight: normal; width: 35%;">Cách hiển thị :</td>
    <td>
