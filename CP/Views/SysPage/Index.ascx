...
<div id="toolbar-box">
    ...
    <div class="m">
        <div class="toolbar-list" id="toolbar">
            <%= GetListCommand("import|Thêm nhiều,new|Thêm,edit|Sửa,space,publish|Duyệt,unpublish|Bỏ duyệt,space,delete|Xóa,copy|Sao chép,space,config|Xóa cache")%>
        </div>
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <%if (parent != null && parent.Name == "Slide"){%>
                    <th style="width:40px" nowrap="nowrap">
                        <%= GetSortLink("Hình minh họa", "File")%>
                    </th>
                    <%} %>
                    ...
                    <th nowrap="nowrap">
                        <%= GetSortLink("Mobile", "TemplateMobileID")%>
                    </th>
                    <%} %>
