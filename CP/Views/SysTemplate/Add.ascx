                ...
                <div id="page-General" class="tab">
                    <table class="admintable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="Device" <%= item.Device ? "checked" : "" %> type="radio" value='1' />
                                Website
                                <input name="Device" <%= !item.Device ? "checked" : "" %> type="radio" value='0' />
                                Mobile
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="text_input" style="height: 350px; <%if (VSW.Core.Web.HttpRequest.IE && VSW.Core.Web.HttpRequest.BrowserVersion == 6)
                                                                                     {%>width: 685px; <%} %>" name="Custom" id="Custom"><%=item.Custom%></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
