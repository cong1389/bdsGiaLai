            ...
            <thead>
                <tr>
                    ...
                    <th style="width:150px" nowrap="nowrap">
                        <%= GetSortLink("Ngày đăng-kết thúc", "DateStart")%>
                    </th>
               ...
               <%for (int i = 0; listItem != null && i < listItem.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                          ...
                          <span style="color:red">Ngày đăng:  <%= string.Format("{0:dd-MM-yyyy}", listItem[i].DateStart) %></span><br />
                          <span style="color:chocolate">hết hạn:  <%= string.Format("{0:dd-MM-yyyy}", listItem[i].DateEnd) %></span><br />
