...
<%
    ...
    var listEntity = ViewBag.Data as List<ModVoteEntity>;
%>
                ...
                <td nowrap="nowrap">
                   Chuyên mục : 
                    <select id="filter_menu" onchange="VSWRedirect()" class="inputbox" size="1">
                         ...
                         <%= Utils.ShowDDLMenuByType("Vote", model.LangID, model.MenuID)%> 
                    </select>
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th class="title">
                        <%= GetSortLink("Đáp án", "Name")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Bình chọn", "Value")%>
                    </th>
                    <th nowrap="nowrap">
                        <%= GetSortLink("Câu hỏi", "MenuID")%>
                    </th>
                    <%--<th width="1%" nowrap="nowrap">
                        <%= GetSortLink("I p", "IP")%>
                    </th>--%>
            ...
            <tbody>
               <%for (int i = 0; listEntity != null && i < listEntity.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                       <%= string.Format("{0:#,##0}", listEntity[i].Value)%>
                    </td>
                    <td align="center">
